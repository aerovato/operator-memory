...
- `install-update.test.ts` — OpenCode V1/V2, Pi, and managed Code Puppy installation plus Bun/npm automatic update, release-age override, channel fallback, and failure coverage
