...
- [`helper/`](helper.md) - Published harness installation, upgrade, setup, status, guide, Git, and Project Index lint CLI.
...
- `scripts/publish-helper.sh`, `scripts/publish-opencode.sh` - Preflight-validated package check, build, version, lockfile, commit, tag, and atomic push release automation; accepts `X.Y.Z` or `vX.Y.Z`.
