...
- `.github/workflows/publish-helper.yml`, `.github/workflows/publish-opencode.yml`, `.github/workflows/publish-opencode-v2.yml`, `.github/workflows/publish-pi.yml` - Independent tag-driven npm provenance publishing and GitHub releases.
